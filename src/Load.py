...
class Load:
    ...
    def __init__(self, base_load_kw, peak_load_max_kw, 
        ...
        Args:
            ...
            peak_load_max_kw (float): Maximum additional load during peaks
        ...
        self._peak_load_max_kw = peak_load_max_kw
    ...
    def get_demand(self, hour_of_day):
        ...
        if self._peak_hours_start <= hour_of_day < self._peak_hours_end:
            ...
            total_demand += random.uniform(1.0, self._peak_load_max_kw)
